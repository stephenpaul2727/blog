...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('//stephensblog.herokuapp.com/public/css/master-style.css') }}">
    <link rel="stylesheet" href="{{ asset('//stephensblog.herokuapp.com/public/css/font-awesome.css') }}">
