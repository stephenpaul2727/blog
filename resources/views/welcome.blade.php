...
<div class="container-fluid bg-1 text-center">
    ...
    <img src="{{ asset('//stephensblog.herokuapp.com/public/images/stephen.jpg')}}" class="img img-circle img-responsive margin" style="display:inline" alt="Stephen's Pic" height="200" width="200">
